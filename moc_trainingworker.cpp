...
template <> constexpr inline auto TrainingWorker::qt_create_metaobjectdata<qt_meta_tag_ZN14TrainingWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(float, int, int, int, int)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Float, 9 }, { QMetaType::Int, 10 }, { QMetaType::Int, 11 }, { QMetaType::Int, 12 },
            { QMetaType::Int, 13 },
        }}),
        // Slot 'train'
...
void TrainingWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->trainingComplete((*reinterpret_cast< std::add_pointer_t<float>>(_a[1]))); break;
        case 2: _t->evaluationComplete((*reinterpret_cast< std::add_pointer_t<float>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[3])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[4])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[5]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TrainingWorker::*)(int , int , float )>(_a, &TrainingWorker::progressUpdated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrainingWorker::*)(float )>(_a, &TrainingWorker::trainingComplete, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrainingWorker::*)(float , int , int , int , int )>(_a, &TrainingWorker::evaluationComplete, 2))
            return;
    }
}
