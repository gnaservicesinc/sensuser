...
# Template: app
# Command: /opt/Qt/6.9.1/macos/bin/qmake -o Makefile sensuser.pro
#############################################################################
