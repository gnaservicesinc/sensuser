...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        cbOptimizer = new QComboBox(groupBox_3);
        cbOptimizer->addItem(QString());
        cbOptimizer->addItem(QString());
        cbOptimizer->addItem(QString());
        cbOptimizer->setObjectName("cbOptimizer");

        gridLayout_3->addWidget(cbOptimizer, 4, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_10->setText(QCoreApplication::translate("MainWindow", "Optimizer:", nullptr));
        cbOptimizer->setItemText(0, QCoreApplication::translate("MainWindow", "SGD (Stochastic Gradient Descent)", nullptr));
        cbOptimizer->setItemText(1, QCoreApplication::translate("MainWindow", "RMSprop", nullptr));
        cbOptimizer->setItemText(2, QCoreApplication::translate("MainWindow", "Adam", nullptr));

#if QT_CONFIG(tooltip)
        cbOptimizer->setToolTip(QCoreApplication::translate("MainWindow", "Selects the optimization algorithm used during training. Adam is recommended as a good default for most problems.", nullptr));
